...
OpenPuck runs on nRF52840 "Pro Micro" boards (the common SuperMini clones and the Adafruit Feather nRF52840) and on the **Seeed XIAO nRF52840** (including the Sense), which is easy to get in the EU. Grab the UF2 that matches your board from the releases:
