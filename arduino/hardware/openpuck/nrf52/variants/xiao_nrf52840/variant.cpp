 ...
 *
 * Adapted verbatim from Seeed-Studio/Adafruit_nRF52_Arduino,
 * variants/Seeed_XIAO_nRF52840/variant.cpp (LGPL-2.1). The pin map and
 * initVariant() are unchanged: initVariant() deselects the on-board QSPI flash,
 * disables the battery-sense divider, and parks all three LED channels HIGH
 * (off, since the RGB LED is common-anode / active LOW).
 */
