...
#define TB_TOUCH  0x800000u      // virtual: PS Touch Click (back-paddle target, not a real Triton button)
#define TB_MUTE   0x1000000u     // virtual: PS5 Mute button (back-paddle target, not a real Triton button)
