...
// rumble 1 = enabled (default), 0 = host rumble silenced for that type. rumbleScale 100 = full/native
// strength (default), 0 = off; below 100 the motor is PWM-attenuated -- per emulated type.
...
// Live mirror of the active type's rumble strength % (100 = full/native default; below 100 = PWM-attenuated).
// Set by applyActiveType(); the per-type source of truth is g_type[et].rumbleScale, edited from the panel.
