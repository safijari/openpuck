...
Commands the Steam Controller (2026) supports: 
...
- 0x90: `REBOOT_TO_BOOTLOADER` / `REBOOT_TO_ISP`
- 0x95: `FIRMWARE_UPDATE_REBOOT`
- 0x9F: `TURN_OFF_CONTROLLER`
- 0xA1: `GET_DEVICE_INFO`
- 0xA2: On Puck: `TRITON_A2_OBSERVED_PAIRING_RECORD`, on controller: `WRITE_CALIBRATION_DATA` ????
- 0xA3: `TRITON_A3_BOND_EVENT_OR_STATUS` (not real name)
...
- 0xED: `TRITON_READ_SETTING`
- 0xEE: `TRITON_STAGE_SETTING` (write)
- 0xEF: `TRITON_COMMIT_SETTING` (save)
- 0xF0: `TRITON_DELETE_SETTING`
- 0xF2: `GET_SYSTEM_INFO`
